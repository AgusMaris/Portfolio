  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 py-20">
      ...
      <div className="relative z-10 max-w-4xl">
        <div className="anim-hero-stagger-1">
          <p className="text-primary font-mono text-sm md:text-base mb-4">
            {dict.greeting}
          </p>
        </div>

        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 anim-hero-stagger-2">
          Agustin Mariscotti.
        </h1>

        <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mb-8 leading-relaxed anim-hero-stagger-4">
          {dict.description.split("<highlight>").map((part, i) => {
            if (i === 0) return part;
        ...
        <div className="flex flex-wrap gap-4 mb-12 anim-hero-stagger-5">
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 anim-hero-scroll-hint">
        <div className="anim-hero-scroll-bounce">
